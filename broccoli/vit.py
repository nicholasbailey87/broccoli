...
class ViTEncoder(nn.Module):
    ...
    def __init__(
        ...
        transformer_depthwise_linear_stochastic_depth=True,
        ...
        if transformer_layers > 0:
            self.transformer = TransformerEncoder(
                ...
                depthwise_linear_stochastic_depth=transformer_depthwise_linear_stochastic_depth,
                causal=False,
...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = ViTEncoder(
            ...
            transformer_depthwise_linear_stochastic_depth=transformer_depthwise_linear_stochastic_depth,
            linear_module=linear_module,
            alpha=self.alpha,
            beta=self.beta,
        )
